...
test.describe('Adding quantity on home page', async () => {
    ...
    test('Test for adding qunatity 4 for laptop pro', async({page}) =>{
        ...
        home.clickAddQuantityWirelessMouse();
        //Add quantity 4 for wireless_mouse
        home.addQuantityWirelessMouse('4');
        //Add to cart wireless_mouse
        home.addToCartWirelessMouse();
